<?php
	...
	if(mysqli_num_rows($result) == 0){
		// echo "Empty Product ! Please wait until new product coming!";
		echo "<script type='text/javascript'>alert('Empty Product ! Please wait until new product coming!');window.location.href='publisher_list.php';</script>";
		exit;
	}
...
?>
	<p class="lead"><a href="publisher_list.php">Products</a> > <?php echo $pubName; ?></p>
